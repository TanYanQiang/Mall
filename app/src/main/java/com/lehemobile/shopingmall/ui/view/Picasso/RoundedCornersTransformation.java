...
public class RoundedCornersTransformation implements Transformation {
    ...
    public RoundedCornersTransformation(int radius, int margin, int borderWidth, int borderColor) {
        this(radius, margin, CornerType.ALL);
        ...
        switch (mCornerType) {
            case ALL:
                if (borderWidth > 0) {
                    ...
                    canvas.drawRoundRect(new RectF(mMargin, mMargin, right, bottom), mRadius, mRadius, borderPaint);
                }
                canvas.drawRoundRect(new RectF(mMargin+borderWidth, mMargin+borderWidth, right - borderWidth, bottom- borderWidth), mRadius, mRadius, paint);
    ...
    public String key() {
        return "RoundedTransformation(radius=" + mRadius + ", margin=" + mMargin + ", diameter="
                + mDiameter + ", cornerType=" + mCornerType.name() + ", borderWidth=" + borderWidth + ",borderColor =" + borderColor + ")";
    }
}
