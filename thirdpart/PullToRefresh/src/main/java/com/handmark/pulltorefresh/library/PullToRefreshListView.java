...
public class PullToRefreshListView extends PullToRefreshAdapterViewBase<ListView> {
    ...
    public final void onRefreshCompleteDelayShow(String showInfo,long delayMillis) {
        if (isRefreshing()) {
            if(getMode().showHeaderLoadingLayout()){
                mHeaderLoadingView.delayShow(showInfo);
                mHeaderLoadingView.postDelayed(new Runnable() {
                    @Override
                    public void run() {
                        mHeaderLoadingView.completeShow();
